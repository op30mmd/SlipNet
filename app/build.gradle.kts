...
android {
    ...
    buildTypes {
        release {
            ...
            // FIX: Only use the release signing config if the keystore properties actually exist.
            // Otherwise, fall back to the default debug key so the CI build doesn't crash.
            if (keystorePropertiesFile.exists()) {
